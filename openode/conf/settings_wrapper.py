"""
Definition of a Singleton wrapper class for openode.deps.livesettings
...
openode_settings.BLAH

NOTE that at the moment there is distinction between settings
(django settings) and openode_settings (forum.deps.livesettings)

the value will be taken from openode.deps.livesettings database or cache
...
openode.deps.livesettings is a module developed for satchmo project
"""
from django.core.cache import cache
from openode.deps.livesettings import SortedDotDict, config_register
from openode.deps.livesettings.functions import config_get
from openode.deps.livesettings import signals
...
class ConfigSettings(object):
    ...
    def __getattr__(self, key):
        ...
        depending on django.conf.settings to openode.deps.livesettings
        """
    ...
    def update(self, key, value):
        try:
            ...
            from openode.deps.livesettings.models import Setting
    ...
    def register(self, value):
        ...
        value must be a subclass of openode.deps.livesettings.Value
        """
        key = value.key
    ...
    def as_dict(self):
        settings = cache.get('openode-livesettings')
        if settings:
            return settings
        else:
            self.prime_cache()
            return cache.get('openode-livesettings')
    ...
    def prime_cache(cls, **kwargs):
        ...
        cache.set('openode-livesettings', out)
