...
TYPE_ACTIVITY_ASK_TO_CREATE_ORG = 39
...
TYPE_ACTIVITY = (
    ...
    (TYPE_ACTIVITY_ASK_TO_CREATE_ORG, _('user asks to create organization')),
    (
...
LOG_ACTION_ASK_TO_CREATE_ORG = 81
LOG_ACTION_ASK_TO_CREATE_ORG_ACCEPTED = 82
LOG_ACTION_ASK_TO_CREATE_ORG_DECLINED = 83
...
LOG_ACTIONS = (
    ...
    (LOG_ACTION_ASK_TO_CREATE_NODE, _('ask to create organization')),
    (LOG_ACTION_ASK_TO_CREATE_NODE_ACCEPTED, _('agreed to create organization')),
    (LOG_ACTION_ASK_TO_CREATE_NODE_DECLINED, _('declined to create organization')),
