...
from django.http import Http404, str_to_unicode
...
from openode.utils.functions import split_list


DEFAULT_NEXT = '/' + getattr(settings, 'OPENODE_URL')
...
class UserEmailField(forms.EmailField):
    ...
    def clean(self, email):
        ...
        allowed_domains = openode_settings.ALLOWED_EMAIL_DOMAINS.strip()
        allowed_emails = openode_settings.ALLOWED_EMAILS.strip()
...
class SetPasswordForm(forms.Form):
    password1 = forms.CharField(
        ...
        widget=forms.PasswordInput(attrs=login_form_widget_attrs),
        label=_('Password'),
