...
class RssIndividualQuestionFeed(Feed):
    ...
    def title(self):
        return openode_settings.APP_TITLE + _(' - ') + \
                _('Individual question feed')

    def feed_copyright(self):
        return openode_settings.APP_COPYRIGHT

    def description(self):
        return openode_settings.APP_DESCRIPTION
    ...
    def item_link(self, item):
        ...
        """
        return openode_settings.APP_URL + item.get_absolute_url()

    def link(self):
        return openode_settings.APP_URL
...
class RssLastestQuestionsFeed(Feed):
    ...
    def item_author_link(self, item):
        ...
        """
        return openode_settings.APP_URL + item.author.get_profile_url()
    ...
    def item_guid(self, item):
        ...
        """
        return openode_settings.APP_URL + item.get_absolute_url(no_slug = True)
