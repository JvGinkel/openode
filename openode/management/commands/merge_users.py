...
# In MySQL: "Warning: (1062, "Duplicate entry 'm_and_c-2' for key 'openode_emailfeedsetting_feed_type_6da6fdcd_uniq'")"
# In PostgreSQL: "Warning: duplicate key value violates unique constraint "openode_emailfeedsetting_feed_type_6da6fdcd_uniq"
