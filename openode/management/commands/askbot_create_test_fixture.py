...
from openode.utils.console import choice_dialog


# FULL PATH HERE
# DEFAULTS TO openode_path/tests/test_data.json
FIXTURE_NAME = os.path.join(os.path.dirname(openode.__file__),
...
EXCLUDE_APPS = ['contenttypes',
                'sites',
                'openode.activity',
                'openode.activityauditstatus',
                'openode.badgedata',
                'openode.Post',
                'openode.EmailFeedSetting',
                'auth.Message']
...
class Command(NoArgsCommand):
    ...
    def handle_noargs(self, **options):
        ...
        management.call_command('openode_add_test_content', verbosity=0,
                                                        interactive=False)
