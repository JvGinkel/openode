...
from openode.deps.livesettings import config_value
from openode.deps.livesettings.utils import url_join
import logging
...
def admin_site_views(view):
    ...
    paths = ["http://", settings.DOMAIN_NAME]
    if path:
        paths.append(path)
...
register.inclusion_tag('openode.deps.livesettings/_admin_site_views.html')(admin_site_views)
