...
from openode.deps.livesettings.models import find_setting, LongSetting, Setting, SettingNotSet
from openode.deps.livesettings.utils import load_module, is_string_like, is_list_or_tuple
from openode.deps.livesettings.widgets import ImageInput
import datetime
import logging
import signals
import os
...
class Value(object):
    ...
    def update(self, value):
        ...
        if use_db:
            ...
            log.debug('not updating setting %s.%s - openode.deps.livesettings db is disabled',self.group.key, self.key)
