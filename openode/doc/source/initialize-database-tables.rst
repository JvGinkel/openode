...
=======================================================
Initialization and upgrade of the database for Pluto
=======================================================

When you install Pluto the first time and any time you upgrade the software, run these two commands::

    python manage.py syncdb

.. versionchanged:: 0.7.21
    When the script asks you if you want to create a superuser, answer yes if you want to create one. By default Pluto sets admin status(superuser) for the first user created automatically but also supports this form.
...
Then run::
    ...
    python manage.py migrate pluto
...
.. note::
    ...
    the IP manually or replace it with word `localhost` if you are installing pluto 
    on a local machine.
...
Once the fresh copy of Pluto appears in your browser, create a new account at the site.
...
.. versionadded:: 0.7.20
   In the new version of Pluto the first user you create on the site will be added as administrator.
