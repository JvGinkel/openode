# -*- coding: utf-8 -*-
#
# Openode documentation build configuration file, created by
...
templates_path = ['_templates', 'openode']
...
project = u'Openode'
copyright = u'2011, Openode Project'
...
modindex_common_prefix = ['openode.']
...
latex_documents = [
  ('index', 'Openode.tex', u'Openode Documentation',
...
man_pages = [
    ('index', 'openode', u'Openode Documentation',
     [u'Evgeny Fadeev'], 1)
]
