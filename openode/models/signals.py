"""Custom django signals defined for the openode forum application.
"""
...
edit_thread_or_answer = django.dispatch.Signal(
...
def pop_all_db_signal_receivers():
    ...
    """
    #this is the only openode signal that is not defined here
    #must use this to avoid a circular import
    signals = (
        #openode signals
        tags_updated,
        edit_thread_or_answer,
